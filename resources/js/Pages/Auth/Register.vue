                    ...
                    <form action="#" class="mt-8 grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <input
                                type="text"
                                id="name"
                                class="w-full rounded-lg border border-purple-200 bg-white py-2 pl-10 pr-4 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-0 focus:border-purple-500"
                            />
                        </div>
